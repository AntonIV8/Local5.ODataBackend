...
namespace IIS.local5
{
    ...
    [View("CatL", new string[] {
            "CatName as \'Cat name\'",
            "Weight as \'Weight\'"})]
    public class Cat : IIS.local5.Animal
    {
        
        private string fCatName;
        
        private IIS.local5.DetailArrayOfPaws fPaws;
        ...
        public virtual IIS.local5.DetailArrayOfPaws Paws
        {
            get
            {
                ...
                if ((this.fPaws == null))
                {
                    this.fPaws = new IIS.local5.DetailArrayOfPaws(this);
                }
                IIS.local5.DetailArrayOfPaws result = this.fPaws;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View CatE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("CatE", typeof(IIS.local5.Cat));
                }
            }
            ...
            public static ICSSoft.STORMNET.View CatL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("CatL", typeof(IIS.local5.Cat));
                }
            }
        }
    }
